...
namespace MvcLogin.Repositories
{
    public class RepoUser
    {
        ...
        public RepoUser()
        {
            string connStr = "Data Source=LUCKYBOI;Initial Catalog=qlqs;Persist Security Info=True;User ID=LK;Password=1;Trust Server Certificate=True";
        ...
        #region xem quân số của đơn vị
        public List<QuanSo> GetBaoCaoQuanSoByIddv(string IdDv)
        {
            List<QuanSo> qs = new List<QuanSo>();
